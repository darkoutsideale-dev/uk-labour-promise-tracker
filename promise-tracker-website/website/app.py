...
# -----------------------------
# Summary metrics (Stripped percentage progress)
# -----------------------------
...
with m4:
    st.markdown(
        ...
        <div class="metric-card">
            ...
            <div class="metric-note">Promises actively moving forward</div>
        </div>
        """,
        unsafe_allow_html=True
    )
...
# -----------------------------
# Promise Detail and Evidence (Clean Stage-Based Display)
# -----------------------------
st.markdown('<div class="glass-card">', unsafe_allow_html=True)
...
# Focused 3-Column layout replacing numerical progress configurations
d1, d2, d3 = st.columns(3)

d1.metric("Verified Status", pretty_status(selected["status"]))
d2.metric("Algorithmic Suggestion", pretty_status(auto_status))
d3.metric("Supporting Sources", f"{int(auto_evidence_count)} documents")
